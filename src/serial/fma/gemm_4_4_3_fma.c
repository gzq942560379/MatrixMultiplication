...
void AddDot_4_4(int k, double *a, double *b, double *c, int la, int lb, int lc) {
    ...
    for (int l = 0; l < k; ++l) {
        ...
        c_r_0.v = _mm256_fmadd_pd(a_0l_4.v, b_r_l.v, c_r_0.v);
        c_r_1.v = _mm256_fmadd_pd(a_1l_4.v, b_r_l.v, c_r_1.v);
        c_r_2.v = _mm256_fmadd_pd(a_2l_4.v, b_r_l.v, c_r_2.v);
        c_r_3.v = _mm256_fmadd_pd(a_3l_4.v, b_r_l.v, c_r_3.v);
    }
