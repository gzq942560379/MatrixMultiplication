...
void AddDot_4_1(int k, double *a, double *b, double *c, int la, int lb, int lc) {
    ...
    for (int l = 0; l < k; l += 4) {
        ...
        b_l_0_reg = B(l + 1, 0);
        c_0_0_reg += *(a_0l_ptr + 1) * b_l_0_reg;
        c_1_0_reg += *(a_1l_ptr + 1) * b_l_0_reg;
        c_2_0_reg += *(a_2l_ptr + 1) * b_l_0_reg;
        c_3_0_reg += *(a_3l_ptr + 1) * b_l_0_reg;

        b_l_0_reg = B(l + 2, 0);
        c_0_0_reg += *(a_0l_ptr + 2) * b_l_0_reg;
        c_1_0_reg += *(a_1l_ptr + 2) * b_l_0_reg;
        c_2_0_reg += *(a_2l_ptr + 2) * b_l_0_reg;
        c_3_0_reg += *(a_3l_ptr + 2) * b_l_0_reg;

        b_l_0_reg = B(l + 3, 0);
        c_0_0_reg += *(a_0l_ptr + 3) * b_l_0_reg;
        c_1_0_reg += *(a_1l_ptr + 3) * b_l_0_reg;
        c_2_0_reg += *(a_2l_ptr + 3) * b_l_0_reg;
        c_3_0_reg += *(a_3l_ptr + 3) * b_l_0_reg;
